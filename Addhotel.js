...
const Addhotel=()=>{
    useEffect(()=>{
        document.title="ADD Hotel || Learn Code with Pragati";
    },[]);
...
const postDatatoServer=(data)=>{
    axios.post(`${base_url}/hotels`,data).then(
        (response)=>{
            ...
            console.log("success");
            toast.success("Hotel Information added successfully",{position:"bottom-center"});
        },
        (error)=>{
            console.log(error);
            console.log("error");
        ...
        <Form onSubmit={handleForm}>
            ...
            <FormGroup>
                ...
                <Container className="text-center">
                    <Button type="submit" color="success">Add Hotel</Button>{' '}
